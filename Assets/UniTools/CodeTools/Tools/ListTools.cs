...
namespace UniTools
{
    public static class ListTools
    {
        ...
        {
            return ResizeList(list, size, getValue);
        }
        public static List<T> Resize<T>(this List<T> list, int size, T defaultValue = default)
        {
            return ResizeList(list, size, i => defaultValue);
        }
        public static List<T> ResizeList<T>(this List<T> source, int size, Func<int, T> getValue)
        {
            var list =  source ;
